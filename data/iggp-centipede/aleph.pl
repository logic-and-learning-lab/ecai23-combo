...
:- determination(next_control/2,int_0/1).
:- determination(next_control/2,int_5/1).
:- determination(next_control/2,int_10/1).
:- determination(next_control/2,int_15/1).
:- determination(next_control/2,int_20/1).
:- determination(next_control/2,int_25/1).
:- determination(next_control/2,int_30/1).
:- determination(next_control/2,int_35/1).
:- determination(next_control/2,int_40/1).
:- determination(next_control/2,int_45/1).
:- determination(next_control/2,int_50/1).
:- determination(next_control/2,int_55/1).
:- determination(next_control/2,int_60/1).
:- determination(next_control/2,int_65/1).
:- determination(next_control/2,int_70/1).
:- determination(next_control/2,int_75/1).
:- determination(next_control/2,int_80/1).
:- determination(next_control/2,int_85/1).
:- determination(next_control/2,int_90/1).
:- determination(next_control/2,int_95/1).
:- determination(next_control/2,int_100/1).
:- determination(next_control/2,action_finish/1).
:- determination(next_control/2,action_continue/1).
:- determination(next_control/2,action_noop/1).
:- determination(next_control/2,prop_gameOver/1).
...
:- determination(next_control/2,next_control/2).
